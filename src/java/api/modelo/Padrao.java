...
public class Padrao extends Identificador {
    ...
    public Padrao(int id, String nome, String tamanho, String tipo, InputStream inputStream) {
        super(id);
        this.nome = nome;
    ...
    public void setImage(File file) {
        try {
            ...
            System.out.println("Falha Leitura Padrao - Image : " + this.getNome());
        }
        ...
        try {
            ...
            System.out.println("Falha Leitura Padrao - InputStream : " + this.getNome());
        }
