...
<html>
    ...
    <body>
        ...
        <div class="content">
            ...
            <form method="post" action="${pageContext.request.contextPath}/AutenticaCadastro">
                ...
                <input class="formInput formTextInput" id="psw"  type="password" name="senha" title="Senha precisa ser maior que 6" pattern="([A-z0-9À-ž\s]){3,}" required></br>

                <label class="texto"  for="psw2">Confirme Senha</label>
                <input class="formInput formTextInput" id="psw2"  type="password" name="confirmation" title="Senha precisa ser maior que" pattern="([A-z0-9À-ž\s]){3,}" required></br>
