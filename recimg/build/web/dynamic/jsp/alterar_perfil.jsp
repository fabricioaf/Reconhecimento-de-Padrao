    ...
    <body>
        ...
        <div class="content">
            ...
            <div id="sub_content">
                ...
                <h3> <%= u.getEmail()%> </h3>
                <%}%>
                <form method="post" action="${pageContext.request.contextPath}/AtualizacaoPerfil">
                    <p>Nome</p>
                    <input name="novoNome" class="formInput formTextInput" title="Insira novo nome"></br>
                    <p>Email</p>
                    <input name="novoEmail" class="formInput formTextInput" title="Insira novo Email"></br>
                    <p>Senha Atual</p> 
                    <input class="formInput formTextInput" name="senha" type="password" title="Insira sua senha"  pattern="([A-z0-9À-ž\s]){3,}"></br>
                    <p>Nova Senha</p>
                    <input class="formInput formTextInput" name="senhaCheck" type="password" title="Insira nova senha"  pattern="([A-z0-9À-ž\s]){3,}"></br>
                    <p>Confirme Nova Senha</p>
                    <input class="formInput formTextInput" name="senhaCheckConfirmation" type="password" title="Insira nova senha"  pattern="([A-z0-9À-ž\s]){3,}"></br>
